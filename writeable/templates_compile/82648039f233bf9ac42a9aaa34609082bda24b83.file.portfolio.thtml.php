<?php /* Smarty version Smarty-3.0.6, created on 2015-10-28 02:06:32
...
.  All Rights Reserved.  &nbsp;&nbsp;&nbsp;<?php echo smarty_function_menu(array('name'=>"footer_menu",'show_sub_menus'=>"off",'class'=>"footer_menu"),$_smarty_tpl);?>
	...
	<?php if ($_smarty_tpl->getVariable('logged_in')->value){?>
		<div id="idea-bar">
			...
			<form class="form validate" enctype="multipart/form-data" method="post" action="http://www.example.com/portfolios/trade/buy">
			...
			<select>
			  <option value="buytoopen">BUY TO OPEN</option>
			  <option value="selltoopen">SELL TO OPEN</option>
			  <option value="buytoclose">BUY TO CLOSE</option>
			  <option value="selltoclose">SELL TO CLOSE</option>
			</select> 
			<input type="text" name="size" placeholder="size"/>
			<select style="width:250px;">
			  <option value="buytoopen">I own this position</option>
			  <option value="selltoopen">I own the opposite position</option>
			  <option value="buytoclose">I do not own this position, and will not own this position or it's opposite within the next 72hr </option>
			  <option value="selltoclose">I will own this position within the next 72hr</option>
			  <option value="selltoclose">I will own the opposite position within the next 72hr</option>
			</select>
